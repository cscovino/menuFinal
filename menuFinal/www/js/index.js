var app = {
    ...
    nextPage: function(data){
        ...
        document.getElementsByClassName('title-clients')[1].innerHTML = '<span style="font-style:italic;color:#00a5ba;font-size:24px;margin-top:10px;">' + data.innerHTML + '</span>, escoge aquí tu bebida';
